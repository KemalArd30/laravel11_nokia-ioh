...
{{-- <script>
  var searchRoute = "{{ route('sid.index') }}";
</script>
<script src="{{ asset('js/sid-liveSearch.js') }}"></script> --}}
...
<div class="bg-body rounded shadow-sm mt-2 p-0">
    ...
    <div class="sub-content pb-0 pt-0">
        <ul class="item-content">
            ...
            <li><a href="{{ route('sid.export') }}" class="export-data"><i class="fa-solid fa-file-export"></i> Export Data</a></li>
        </ul>
    </div>
        ...
        <div id="sid-table-container">
          @include('partials.sid-search-results', ['dataSidList' => $dataSidList])
        </div> --}}
        ...
        <div class="table-responsive">
          <table 
              ...
              <thead class="wrap-text">
                ...
                <th class="text-center" data-field="sid_file_naming" data-sortable="true">SID File Naming</th>
                <th class="text-center" data-field="upload_date_sid_ppm" data-sortable="true">Upload Date SID PPM</th>
                <th class="text-center" data-field="url_sid_ppm" data-sortable="true">Url SID PPM</th>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form class="pb-3" action="{{ url('sid') }}" method="get">
              ...
              <div class="mb-3 row d-flex align-items-center">
                ...
                <div class="mb-3 row">
                  <label for="uploadDateSidPpm" class="col-sm-2 col-form-label-sm">Upload SID PPM</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control form-control-sm" name="uploadDateSidPpm" value="{{ Request::get('upload_date_sid_ppm') }}" aria-label="uploadDateSidPpm">
                  </div>
                </div>
            </div>
            <div class="modal-footer mb-0">
                <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-warning btn-sm" id="resetButton" data-url="{{ url('sid') }}">Reset</button>
