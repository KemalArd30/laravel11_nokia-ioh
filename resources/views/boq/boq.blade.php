...
{{-- <script>
  var searchRoute = "{{ route('boq.index') }}";
</script>
<script src="{{ asset('js/boq-liveSearch.js') }}"></script> --}}
...
<div class="bg-body rounded shadow-sm mt-2 p-0">
    ...
    <div class="sub-content pb-0 pt-0">
        ...
        <div id="boq-table-container">
          @include('partials.boq-search-results', ['dataBoqList' => $dataBoqList])
        </div> --}}
        ...
        <div class="table-responsive">
          <table 
              ...
              <thead class="wrap-text">
                ...
                <th class="text-center" data-field="boq_file_naming" data-sortable="true">BOQ File Naming</th>
                <th class="text-center" data-field="upload_date_boq_ppm" data-sortable="true">Upload Date BOQ PPM</th>
                <th class="text-center" data-field="url_boq_ppm" data-sortable="true">URL BOQ PPM</th>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form class="pb-3" action="{{ url('boq') }}" method="get">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control form-control-sm" name="upload_date_boq_ppm" value="{{ Request::get('upload_date_boq_ppm') }}" aria-label="upload_date_boq_ppm">
              </div>
            </div>
                <div class="mb-3 row">
            ...
            <div class="modal-footer mb-0">
                ...
                <button type="button" class="btn btn-warning btn-sm" id="resetButton" data-url="{{ url('boq') }}">Reset</button>
