...
{{-- <script>
  var searchRoute = "{{ route('atf.index') }}";
</script>
<script src="{{ asset('js/atf-liveSearch.js') }}"></script> --}}
...
<div class="bg-body rounded shadow-sm mt-2 p-0">
    ...
    <div class="sub-content pb-0 pt-0">
        ...
        <div id="atf-table-container">
          @include('partials.atf-search-results', ['dataAtfList' => $dataAtfList])
        </div> --}}
        ...
        <div class="table-responsive">
          <table 
              ...
              <thead class="wrap-text">
                ...
                <th class="text-center" data-field="atf_file_naming" data-sortable="true">ATF File Naming</th>
                <th class="text-center" data-field="upload_date_atf_ppm" data-sortable="true">Upload Date ATF PPM</th>
                <th class="text-center" data-field="url_atf_ppm" data-sortable="true">URL ATF PPM</th>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form class="pb-3" action="{{ url('atf') }}" method="get">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control form-control-sm" name="upload_date_atf_ppm" value="{{ Request::get('upload_date_atf_ppm') }}" aria-label="upload_date_netgear_mos_ppm">
              </div>
            </div>
                <div class="mb-3 row">
            ...
            <div class="modal-footer mb-0">
                ...
                <button type="button" class="btn btn-warning btn-sm" id="resetButton" data-url="{{ url('atf') }}">Reset</button>
