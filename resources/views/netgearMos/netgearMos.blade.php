...
{{-- <script>
  var searchRoute = "{{ route('netgearMos.index') }}";
</script>
<script src="{{ asset('js/netgearMos-liveSearch.js') }}"></script> --}}
...
<div class="bg-body rounded shadow-sm mt-2 p-0">
    ...
    <div class="sub-content pb-0 pt-0">
        ...
        <div id="netgearMos-table-container">
          @include('partials.netgearMos-search-results', ['dataNetgearMosList' => $dataNetgearMosList])
        </div> --}}
        ...
        <div class="table-responsive">
          <table 
              ...
              <thead class="wrap-text">
                ...
                <th class="text-center" data-field="netgear_mos_file_naming" data-sortable="true">NETGear MOS File Naming</th>
                <th class="text-center" data-field="upload_date_netgear_mos_ppm" data-sortable="true">Upload Date NETGear MOS PPM</th>
                <th class="text-center" data-field="url_netgear_mos_ppm" data-sortable="true">URL NETGear MOS PPM<</th>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form class="pb-3" action="{{ url('netgearMos') }}" method="get">
              <div class="modal-body">
                ...
                <div class="mb-3 row d-flex align-items-center">
                  <label for="is13_1_main_equipment_is_onsite" class="col-sm-2 col-form-label-sm">IS13.1</label>
                  <div class="col-sm-4">
              ...
              <div class="mb-3 row d-flex align-items-center">
                ...
                <label for="netgear_mos_status" class="col-sm-1 ms-auto col-form-label-sm">Status NETGear MOS</label>
                <div class="col-sm-4 ms-auto">
                  <select class="form-select form-select-sm" name="netgear_mos_status" id="netgear_mos_status">
                    <option value="">Choose Status...</option>
                    <option value="PMR NY Upload" {{ Request::get('netgear_mos_status') == 'PMR NY Upload' ? 'selected' : '' }}>PMR NY Upload</option>
                    <option value="NY Tagging" {{ Request::get('netgear_mos_status') == 'NY Tagging' ? 'selected' : '' }}>NY Tagging</option>
                    <option value="Reject" {{ Request::get('netgear_mos_status') == 'Reject' ? 'selected' : '' }}>Reject</option>
                    <option value="Approved" {{ Request::get('netgear_mos_status') == 'Approved' ? 'selected' : '' }}>Approved</option>
                </select>
                </div>
              </div>
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input type="date" class="form-control form-control-sm" name="upload_date_netgear_mos_ppm" value="{{ Request::get('upload_date_netgear_mos_ppm') }}" aria-label="upload_date_netgear_mos_ppm">
              </div>
            </div>
                <div class="mb-3 row">
            ...
            <div class="modal-footer mb-0">
                ...
                <button type="button" class="btn btn-warning btn-sm" id="resetButton" data-url="{{ url('netgearMos') }}">Reset</button>
