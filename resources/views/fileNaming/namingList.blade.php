...
@section('title', 'File Naming List')
...
<script src="{{ asset('js/table-fileNaming.js') }}"></script>
...
{{-- <script>
  var searchRoute = "{{ route('filenaming.index') }}";
</script>
<script src="{{ asset('js/naming-liveSearch.js') }}"></script> --}}
...
<div class="bg-body rounded shadow-sm mt-2 p-0">
    ...
    <div class="sub-content pb-0 pt-0">
        <ul class="item-content">
          @if (Auth::check() && Auth::user()->hasRole('admin'))
            ...
            <li><a href="{{ route('filenaming.create') }}" id="import-data"><i class="fa-solid fa-file-import"></i>Import Naming</a></li>
            @endif
            <li><a href="#" data-bs-toggle="modal" data-bs-target="#searchModal" class="filter"><i class="fa-solid fa-filter"></i> Filter</a></li>
            <li><a href="{{ route('filenaming.export') }}" class="export-data"><i class="fa-solid fa-file-export"></i> Export Data</a></li>
        </ul>
    </div>
    ...
    <div id="naming-table-container">
      @include('partials.naming-search-results', ['dataFileNaming' => $dataFileNaming])
    </div> --}}
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form class="pb-3" action="{{ url('filenaming') }}" method="get">
            ...
            <div class="modal-footer mb-0">
                ...
                <button type="button" class="btn btn-warning btn-sm" id="resetButton" data-url="{{ url('filenaming') }}">Reset</button>
