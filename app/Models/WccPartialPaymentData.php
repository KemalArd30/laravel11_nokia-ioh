...
class WCCPartialPaymentData extends Model
{
    use HasFactory;

    protected $table = 'pbi_wcc_partial_payment_data';
    ...
    protected $fillable = [
        ...
        'wcc_submission_date_categorize', 'aging_wcc_approval', 'wcc_approval_categorize', 'loi_date', 'loi_number'
    ];
